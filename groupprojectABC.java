...
public class GroupProjectABC{
    public static double ChargeABC[]=new double[3];
    ...
    public static void Loop() {
        ...
        for(customer=0;customer<ChargeABC.length;customer++){

            /*Display Customer*/
            System.out.printf("\nCustomer %d:\n",customer+1);
            System.out.printf("----------------------\n");

            ChargeABC[customer]=0;
