...
public class GroupProjectABCD{
    public static double ChargeABCD[]=new double[3];
    ...
    public static void Loop() {
        ...
        for(customer=0;customer<ChargeABCD.length;customer++){

            /*Display Customer*/
            System.out.printf("\n\nCustomer %d:\n",customer+1);
            System.out.printf("----------------------\n");

            ChargeABCD[customer]=0;
            ...
            while(!ItemType.equals("X")){
                ...
                ChargeABCD[customer]+=totalprice;
